...
class EbayScraping(object):
    ...
    def __init__(self,
        ...
        self.config_file = os.path.normpath(os.path.join(self.ROOT_DIR, 'configs/rozetka/parsing-config.yml'))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Process async rozetka scrapping')
